...
当前目录:
```bash
modelscope upload MaZp001/vla_data . --repo-type dataset
```
指定目录:
```bash
modelscope upload MaZp001/vla_data ./logs --repo-type dataset
```
指定文件:
```bash
modelscope upload MaZp001/vla_data \
    ~/Bolt/logs/README.md \
    README.md  \
    --repo-type dataset
```
...
```bash
modelscope download MaZp001/vla_data --local-dir . --repo-type dataset
```
